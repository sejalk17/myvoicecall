			...
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-sm-flex align-items-center justify-content-between">
						<h4>Campaign</h4>
						<a href="{{ route('usercampaignreplica.create') }}" class="btn btn-primary btn-sm"><i
						...
						<div class="card-body">
							...
							<table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
								...
								<tbody>
									...
									@php
									$sound_detail= App\Models\Sound::where('id',$r->voiceclip)->first();
									@endphp
									<tr>
										...
										<td class="product-p">
											<audio controls>
												<source src="{{asset($sound_detail->voiceclip)}}" type="audio/ogg">
												Your browser does not support the audio tag.
											</audio>

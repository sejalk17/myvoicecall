            ...
            <div class="d-flex">
                ...
                <div class="dropdown d-inline-block">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="{{ url('user/userpassword') }}">
       ...
       <div data-simplebar class="h-100">
            <div id="sidebar-menu">
                <ul class="metismenu list-unstyled" id="side-menu">
                    ...
                    <li>
                        <a href="{{ url('user/usersound') }}" class="waves-effect">
                            <i class="bx bx-video-recording"></i>
                            <span key="t-chat">Sound Management</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('user/usercampaign') }}" class="waves-effect">
                            <i class="bx bxs-volume-full"></i>
                            <span key="t-chat">Campaign Management</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ url('user/userwallet') }}" class="waves-effect">
                            <i class="fa fa-wallet"></i>
                            <span key="t-chat">Wallet Management</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('userreport.index') }}" class="waves-effect">
                    ...
                    <li>
                        <a href="{{ route('userreport.checkxlsx') }}" class="waves-effect">
                            <i class='bx bxs-report'></i>
                    ...
                    <li>
                        <a href="{{ url('user/usercampaignclone') }}" class="waves-effect">
                            <i class='bx bxs-report'></i>
                    ...
                    <li>
                        <a href="{{ url('user/usercampaignreplica') }}" class="waves-effect">
                            <i class='bx bxs-report'></i>

...
@section('content')
    <div class="page-content">
                ...
                <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18"><i class="bx bx-user-circle"></i> Agent User Profile</h4>
       ...
       <div class="row">
            ...
            <form method="post" action="{{ url('agentuser/agentuserupdateprofile') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">

...
<head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="{{asset('skote/layouts/assets/images/favicon.ico')}}">

        <!-- Bootstrap Css -->
        <link href="{{asset('skote/layouts/assets/css/bootstrap-dark.min.css')}}" rel="stylesheet" type="text/css" />
        <!-- Icons Css -->
        <link href="{{asset('skote/layouts/assets/css/icons.min.css')}}" rel="stylesheet" type="text/css" />
        <!-- App Css-->
        <link href="{{asset('skote/layouts/assets/css/app-dark.min.css')}}" rel="stylesheet" type="text/css" />
@stack('headerscript')
    </head>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="text-sm-end d-none d-sm-block">
                                <span class="pull-right">Designed and Developed with <span style="color:red">♥</span> by <a href="https://www.eezib.com" target="_blank"> <em><u>Eezib Technology Pvt. Ltd.</u></em></a></span> 
                            </div>
                        </div>
                    </div>
                </div>

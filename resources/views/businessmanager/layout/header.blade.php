	...
	<div class="navbar-header">
		<div class="d-flex">
			...
			<div class="navbar-brand-box">
				<a href="{{url('businessmanager/home')}}" class="logo logo-dark">
				<span class="logo-sm">
				...
				<a href="{{url('businessmanager/home')}}" class="logo logo-light">
				<span class="logo-sm">
				<img src="{{asset('skote/layouts/assets/images/logo-light.png')}}" alt="" height="50">
				</span>
				<span class="logo-lg">
		...
		<div class="d-flex">
			...
			<div class="dropdown d-inline-block">
				...
				<img class="rounded-circle header-profile-user" src="{{asset('skote/layouts/assets/images/users/avatar-1.jpg')}}"
					alt="Header Avatar">
				<span class="d-none d-xl-inline-block" key="t-henry">businessmanager</span>
				<i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i>
				</button>
				<div class="dropdown-menu dropdown-menu-end">
					<!-- item-->
					<a class="dropdown-item text-danger" href="#">{{ Auth::user()->reference_id }}</a>
					<a class="dropdown-item" href="{{ url('businessmanager/bmprofile') }}"> <i class="bx bx-user"></i> Profile</a>
					<a class="dropdown-item" href="{{ url('businessmanager/bspassword') }}"> <i class="bx bx-lock"></i> Password</a>
	...
	<div data-simplebar class="h-100">
		...
		<div id="sidebar-menu">
			...
			<ul class="metismenu list-unstyled" id="side-menu">
				...
				<li>
					<a href="{{ url('businessmanager/home') }}" class="waves-effect">
					<i class="  bx bx-home-circle"></i>
					<span key="t-chat">Dashboard</span>
					</a>
				</li>
				<li>
					<a href="{{ url('businessmanager/bmuser') }}" class="waves-effect">
				...
				<li>
					<a href="{{ route('businesscampaign.index') }}" class="waves-effect">

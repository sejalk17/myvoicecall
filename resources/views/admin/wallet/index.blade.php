                    ...
                    <div class="col-md-6">
                        <div class="card mini-stats-wid bg-darkblue">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div class="flex-grow-1">
                                        <h4 class="mb-0 f-26-bold">{{($transactional_wallet) ? $transactional_wallet : 0}}
                                            </h4>
                                        <p class="text-bold-00">Transcational Balance</p>
                                    </div>
                                    <div class="flex-shrink-0 align-self-center ">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
                                    ...
                                    <thead>
                                        ...
                                        @endif
                                        <tr>
                                            <th style="width: 20px;" class="@if($sort_f == 'id' && $sort_by == 'desc') sorting_desc @elseif($sort_f == 'id' && $sort_by == 'asc') sorting_asc @else sorting @endif" onclick="ascDescFilter('id');">
                                            S.NO.
                                        </th>
...
<script>
    ...
    var ENDPOINT =  "{{$ajexUrl}}";
   var ajexurl = ENDPOINT.replace('amp;', '');
   var ajexurl1 = ajexurl.replace('amp;', '');
   var ajexurl2 = ajexurl1.replace('amp;', '');
   var ajexurl3 = ajexurl2.replace('amp;', '');
   var ajexurl4 = ajexurl3.replace('amp;', '');
    var page = 1;

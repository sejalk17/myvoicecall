        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <hr>
                    <form action="{{ url('admin/Downloadwallettablereport') }}" method="POST">
                                @csrf
                        <div class="row">
                           <div class="col-sm-3">
                                Date Range
                                        <div>
                                            <input
                                                style="background: #000; cursor: pointer; padding: 10px 10px; color:#fff; border: 1px solid #ccc; width: 100%"
                                                type="text" id="reportrange" name="reportrange">
                                        </div>
                           </div>
                           <div class="col-sm-3">
                               
                               Select User
                                                {!! Form::select('retailer',[''=>'-Select superdistributor-']+ $superdistributor,
                                                old('superdistributor'),
                                                ['class'=>'form-control','id'=>'retailer_id','name'=>'superdistributor']) !!}
                           </div>
                           
                           <div class="col-sm-3">
                               
                               Select Status
                                                {!! Form::select('status',[''=>'-Select status-','1'=>'Pending','2'=>'Approved','3'=>'Rejected'],
                                                old('status'),
                                                ['class'=>'form-control','id'=>'status_id','name'=>'status']) !!}
                           </div>
                           <div class="col-sm-3">
...
<script>
    $(function () {
        ...
        $('#datatable-buttons').DataTable({
            ...
            destroy: true,
            ajax: {
                url: '{{ url('admin/getwalletreportdata') }}',
            data: function (d) {

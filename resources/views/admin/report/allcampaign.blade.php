                                ...
                                <form action="{{ request()->url() }}" id="searchForm" method="get">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-3 mt-2">
                                            ...
                                            <div class="col-sm-3 mt-2"  style="float: right;">
                                                <div id="reportrange">
                                ...
                                <table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="@if ($sort_f == 'actual_deliverCount' && $sort_by == 'desc') sorting_desc @elseif($sort_f == 'actual_deliverCount' && $sort_by == 'asc') sorting_asc @else sorting @endif"
                                                onclick="ascDescFilter('actual_deliverCount');">
                                                    Actual Answered
                                            </th>
                                            <th class="@if ($sort_f == 'notActual_DeliverCount' && $sort_by == 'desc') sorting_desc @elseif($sort_f == 'notActual_DeliverCount' && $sort_by == 'asc') sorting_asc @else sorting @endif"
                                                onclick="ascDescFilter('notActual_DeliverCount');">
                                                    Not Actual Answered
                                            </th>
                                            ...
                                            <tr>
                                                ...
                                                <td class="product-headline text-left wide-column">
                                                    <span class="product-price-wrapper">
                                                        ...
                                                        {{ $r->actual_deliverCount == null ? '0' : $r->actual_deliverCount }}
                                                    </span>
                                                </td>
                                                <td class="product-headline text-left wide-column">
                                                    <span class="product-price-wrapper">
                                                        {{-- {{ $notDeliverCount=App\Models\Campaigndata::Where('status',0)->where('campaign_id',$r->id)->count() }} --}}
                                                        {{ $r->notActual_DeliverCount == null ? '0' : $r->notActual_DeliverCount }}
                                                    </span>
                                                </td>
                                                <td class="product-headline text-left wide-column">
                                                    <span class="product-price-wrapper">

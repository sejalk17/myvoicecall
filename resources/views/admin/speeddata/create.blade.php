	...
	@endif
		...
		<div class="row">
			<div class="col-xs-12 col-md-12 col-lg-12 col-sm-12">
				<div class="card">
					<div class="card-body">
						<form method="POST" action="{{ route('adminspeeddata.store') }}" enctype="multipart/form-data">
							@csrf
							<div class="row">
								<div class="col-md-6 form-group">
									...
									<select name="campaigns[]" id="campaigns" class="form-select" multiple>
										...
										<option @if(old('campaigns') == $r->id) selected @endif value="{{$r->id}}">{{ $r->campaign_name }} ({{$r->total_count}}) ({{$r->username}})</option>
										@endforeach
									</select>
								</div>

...
@section('title', 'bbps - Create Ukey ')
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Create Ukey</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="" method="POST" action="{{ route('ukey.store') }}"
                                novalidate>
                                @csrf
                                <div class="mb-3 row">
...
<script>
    ...
    function getCli(){
        ...
        $.ajax({
            ...
            dataType: "json",
            data:{'provider':provider,'selectvalue':"{{old('cli')}}"},
    ...
    function getServiceNo(){
        $.ajax({
            ...
            dataType: "json",
            data:{'provider':$('#apiProvider').val(),'cli':$('#cli').val()},
            success: function (result) {
            console.log(result)

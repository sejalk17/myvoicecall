                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="{{ url('admin/home') }}" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{ asset('skote/layouts/assets/images/logo-light.png') }}" alt=""
                                        height="50">
                                </span>
                                <span class="logo-lg">
                                    <img src="{{ asset('skote/layouts/assets/images/logo-light.png') }}" alt=""
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                                ...
                                <div data-simplebar style="max-height: 230px;">
                                    ...
                                    <a href="javascript: void(0);" class="text-reset notification-item">
                                        <div class="d-flex">
                                            <img src="{{ asset('skote/layouts/assets/images/users/avatar-3.jpg') }}"
                                    ...
                                    <a href="javascript: void(0);" class="text-reset notification-item">
                                        <div class="d-flex">
                                            <img src="{{ asset('skote/layouts/assets/images/users/avatar-4.jpg') }}"
                                                class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                            <div class="flex-grow-1">
                        ...
                        <div class="dropdown d-inline-block">
                            <button type="button" class="btn header-item waves-effect"
                                ...
                                <img class="rounded-circle header-profile-user"
                                    src="{{ asset('skote/layouts/assets/images/users/avatar-1.jpg') }}"
                                    alt="Header Avatar">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item text-danger"
                                    href="#">{{ Auth::user()->reference_id }}</a>
                                <a class="dropdown-item" href="{{ url('admin/adminprofile') }}"><i
                                        class="bx bx-user"></i>Profile</a>
                                <a class="dropdown-item" href="{{ url('admin/adminpassword') }}"> <i
                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="{{ url('admin/sound') }}" class="waves-effect">
                                    <i class="bx bx-video-recording"></i>
                                    <span key="t-chat">Sound Management</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('admin/campaign') }}" class="waves-effect">
                                    <i class="bx bxs-volume-full"></i>
                                    <span key="t-chat">Campaign Management</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('provider.index') }}" class="waves-effect">
                                    <i class="bx bxs-phone-outgoing"></i>
                                    <span key="t-chat">Provider Management</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ url('admin/plan') }}" class="waves-effect">
                                    <i class="bx bxs-volume-full"></i>
                                    <span key="t-chat">Plan Management</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('channel.index') }}" class="waves-effect">
                            ...
                            <li>
                                <a href="{{ route('admincamptype.uploadFile') }}" class="waves-effect">
                                    <i class="bx bxs-key"></i>
                            ...
                            <li>
                                <a href="{{ route('blocknumber.index') }}" class="waves-effect">
                                    <i class="fa fa-wallet"></i>
                                    <span key="t-chat">Block Number Management</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('adminreport.index') }}" class="waves-effect">
                                    <i class='bx bxs-report'></i>
                                    <span key="t-chat">Report Management</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admincamptype.index') }}" class="waves-effect">
                            ...
                            <li>
                                <a href="{{ route('adminspeeddata.index') }}" class="waves-effect">
                                    <i class='bx bxs-widget'></i>
                            ...
                            <!-- <li>
                                <a href="{{ route('websetting.index') }}" class="waves-effect">

                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="" method="POST" action="{{ route('provider.update',$row->id) }}"
                                novalidate>
                                @csrf
                                @method('PUT')
                                <div class="mb-3 row">
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-input form-control" type="text" id="provider" name="provider"
                                            value="{{old('provider',$row->provider)}}">
                                ...
                                <div class="mb-3 row">
                                    <div class="col-md-6">
                                        ...
                                        value="{{old('number',$row->number)}}" maxlength="10" minlength="10">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        value="{{old('landline',$row->landline)}}">

			...
			<div class="row">
				<div class="col-12">
					<div class="page-title-box d-sm-flex align-items-center justify-content-between">
						<h4 class="mb-sm-0 font-size-18"><i class="bx bx-video-recording"></i> All Plans Listing</h4>
						<div class="page-title-right">
							<a href="{{ route('resellerplan.create') }}" class="btn btn-primary btn-sm"><i
							...
							<table class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0"
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<a href="{{route('resellerplan.edit',$r->id)}}" class="btn btn-success btn-rounded"><i class="fa fa-pencil-alt"></i></a>
										</td>

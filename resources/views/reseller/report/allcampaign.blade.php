                                        ...
                                        <tr>
                                            ...
                                            <th class="@if ($sort_f == 'notDeliverCount' && $sort_by == 'desc') sorting_desc @elseif($sort_f == 'notDeliverCount' && $sort_by == 'asc') sorting_asc @else sorting @endif"
                                                ...
                                                <form action="{{ request()->url() }}" method="get"
                                                    id="notDeliverCount">
                                                    <input type="hidden" name="sort_f" value="notDeliverCount">
                                    ...
                                    <tbody>
                                        @foreach ($campaign as $key => $r)
                                            <tr>
                                                ...
                                                <td class="product-headline text-left wide-column">
                                                    <span class="product-price-wrapper">
                                                        <a href="{{ route('resellercampaign.show', $r->id) }}" class="btn btn-primary btn-sm btn-rounded waves-effect waves-light" title="View Details" target="_blank">  <i class="fas fa-eye"></i></a>
                                                    </span>
                                                </td>
                                            </tr>
                                        @endforeach

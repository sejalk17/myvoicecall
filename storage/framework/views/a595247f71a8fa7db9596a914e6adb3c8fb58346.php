    ...
    <div style="padding-top:10% !important">
        <div class="container-fluid">
            ...
            <?php endif; ?>
                ...
                <form class="" method="POST" action="<?php echo e(route('admincamptype.uploadFileStore')); ?>"  novalidate enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="mb-3 row">
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-input form-control" type="text" id="campRefId" name="campRefId"
                                            value="<?php echo e(old('campRefId')); ?>">
                                            <span class="text-danger small"><?php echo e($errors->first('campRefId')); ?></span>
                                    </div>
    ...
    $('.js-switch').change(function () {
        ...
        if (confirm("Are you sure you want to change the camp type status?")) {
            $.ajax({
                type: "GET",
                dataType: "json",
                url: "<?php echo e(route('admincamptype.statusUpdate')); ?>",
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\myvoicecall\resources\views/admin/camptype/upload.blade.php ENDPATH**/ ?>